...
<head>
    ...
    <script>
        $(document).ready(function () {
            //得到戏曲类型和戏曲类型名称
            var typeId_1 = '${typeId}';//这个typeid用来激活页面的特定控件
            var typeName_1 = '${typeName}';
            $("#"+typeId_1).attr("class","active");
...
<script>
    ...
    $("#pre_page").click(function () {
        ...
        if((currentPage - 1) >= 1) {//表示前一页有内容，可以显示
            ...
            //请求后台
            window.location.href="${pageContext.request.contextPath}/OperaManage/jumpToOperaPage?currentPage="+pageIndex+"&typeId="+sendTypeId;//此方法会刷新当前页
        }
    });
